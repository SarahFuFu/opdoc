...
你可以在 [API 参考文档](https://hexo/v2/api/#provide-inject)学习更多关于依赖注入的知识。
...
想了解更多程序化侦听器的内容，请查阅[实例方法 / 事件](https://hexo/v2/api/#实例方法-事件)相关的 API。
...
你可能还没有留意到[数组](https://hexo/v2/guide/list.html#注意事项)或[对象](https://hexo/v2/guide/list.html#对象变更检测注意事项)的变更检测注意事项，或者你可能依赖了一个未被 Vue 的响应式系统追踪的状态。
